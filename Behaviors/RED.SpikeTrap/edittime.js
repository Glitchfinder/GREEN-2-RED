...
var property_list = [
	new cr.Property(ept_float, "Max speed", 50, "The maximum speed, in pixels per second, the object can travel at."),
	new cr.Property(ept_float, "Acceleration", 300, "The rate of acceleration, in pixels per second per second."),
	new cr.Property(ept_float, "Deceleration", 250, "The rate of deceleration, in pixels per second per second."),
