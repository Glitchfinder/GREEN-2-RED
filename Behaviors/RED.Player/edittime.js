function GetBehaviorSettings()
{
	return {
		...
		"id":			"REDPlayer",
		"version":		"1.0",
		"description":	"Moves an object up, down, left, and right.",
...
AddNumberParam("Set player number", "Which player controls this?");
AddAction(10, 0, "Set player number", "", "Set {my} player number to <i>Player {0}</i>.", "Set the controlling player.", "SetPlayerNumber");
...
var property_list = [
	...
	new cr.Property(ept_combo, "Player 2", "No", "If this and 'Multiple players' are enabled, input will be limited to the numpad. If only 'Multiple players' is enabled, input will be limited to WASD. Otherwise, does nothing.", "No|Yes")
	];
